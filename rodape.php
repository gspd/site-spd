...
<table border="0" cellpadding="0" cellspacing="0" id="Rodape">
  <tr>
    <td height="48" align="left" class="RodapeFundo"><table width="900" height="48" border="0" cellpadding="0" cellspacing="0" id="MenuRodape">
      <tr>
        <td width="300" class="RodapeDestaque"> Depto. de Ci&ecirc;ncias de Computa&ccedil;&atilde;o e Estat&iacute;stica</td>
        <td width="2" class="RodapeDivisor"><div align="center"></div></td>
        <td width="65"><div align="center"><?php print("<a href='index.php' class='RodapeTexto'>"); ?><font size=+0> Home</font></a></div></td>
        <td width="2" class="RodapeDivisor"><div align="center"></div></td>
        <td width="420"><div align="center"><a href="http://www.unesp.br/" target="_blank" class="RodapeTexto"><font size=+0>Universidade Estadual Paulista - UNESP</font></a></div></td>
        <td width="2" class="RodapeDivisor"><div align="center"></div></td>
...
<table width="900" border="0" cellpadding="0" cellspacing="0" id="Rodape">
  <tr>
